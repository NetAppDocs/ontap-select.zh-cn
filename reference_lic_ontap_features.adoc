...
* SnapLock Select
+
SnapLock Select 是专为 ONTAP Select 设计的 ONTAP SnapLock 实施，包括 SnapLock Enterprise。它不包括 SnapLock Compliance。有关详细信息，请参见link:https://docs.netapp.com/us-en/ontap/snaplock/index.html["ONTAP SnapLock 文档"^]。
