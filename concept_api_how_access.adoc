...
---
= 了解有关访问 ONTAP Select Deploy API 的信息
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: ONTAP Select Deploy 附带的 REST API 分配了一个版本号。API 版本号与 Deploy 发布版本号无关。ONTAP Select 9.19.1 Deploy 管理实用程序包括 REST API 版本 3。
