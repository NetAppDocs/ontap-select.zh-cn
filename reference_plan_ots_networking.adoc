...
NOTE: 要详细了解如何在虚拟机监控程序主机上配置 vSwitch 和高速接口功能，请参见 link:concept_nw_concepts_chars.html["深度剖析网络"] 一节。
...
有关双 NIC 部署的详细信息，请参见link:concept_nw_concepts_chars.html["深度剖析网络"]节。
...
有关四 NIC 部署的详细信息，请参见link:concept_nw_concepts_chars.html["深度剖析网络"]节。
