...
--
支持 SnapMirror Cloud:: 从 ONTAP Select 9.17.1 开始，ONTAP Select 支持 SnapMirror Cloud。SnapMirror Cloud 是一种许可的 ONTAP 功能，当您部署 ONTAP Select 9.17.1 集群或将现有的 ONTAP Select 集群升级到版本 9.17.1 时，该功能默认处于启用状态。
+
--
https://docs.netapp.com/us-en/ontap/concepts/snapmirror-cloud-backups-object-store-concept.html["了解 SnapMirror Cloud 备份到对象存储"^]。
...
--
已更新KVM虚拟机管理程序支持:: 从 ONTAP Select 9.17.1 开始，Red Hat Enterprise Linux (RHEL) 10.1、10.0、9.7 和 9.6 以及 Rocky Linux 10.1、10.0、9.7 和 9.6 都支持 KVM 虚拟机管理程序。
+
--
[NOTE]
====
