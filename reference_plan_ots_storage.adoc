...
NOTE: 概述了 ESXi 和 KVM 主机的外部存储支持信息。有关详细信息，请参阅 link:reference_plan_ots_vnas.html["VMware ESXi 要求"] 和 link:reference_plan_ots_kvm.html["KVM 要求"]。
...
NOTE: 如果存在硬件 RAID 控制器，请参见 link:concept_stor_concepts_chars.html["深度剖析存储"] 节以了解其他配置要求。
