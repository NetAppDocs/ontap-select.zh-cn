...
ONTAP Select集群由一个、两个、四个、六个、八个、十个或十二个节点组成。每个集群节点都部署为单独的虚拟机，并运行专门设计的ONTAP 9 软件版本。
...
.相关信息
* link:reference_lic_ontap_features.html#ontap-features-automatically-enabled-by-default["了解默认情况下启用的ONTAP功能"]
