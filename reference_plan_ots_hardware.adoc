...
ONTAP Select 支持基于 Intel Xeon Sandy Bridge 和 Advanced Micro Devices (AMD) 处理器的 CPU 型号。
...
.处理器
支持的微处理器包括 Intel Xeon 服务器处理器和 AMD 处理器。

有关详细信息，请参见 link:https://www.intel.com/content/www/us/en/products/processors/xeon/view-all.html?Processor+Type=1003["Intel Xeon 处理器"^] 和 link:https://www.amd.com/en/products/processors/server/epyc.html["AMD EPYC 服务器 CPU"^]。
...
.相关信息
了解 link:concept_lic_platforms.html["ONTAP Select 的平台许可证产品"]
